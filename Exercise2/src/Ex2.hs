...
f2 ns = case drop (262) ns of
              y : ys -> (y + f2 ys) `mod` 65563-- y + (y2 + (y3 + (y4 + (...))))
              [] -> 0
...
f3 ns = case drop (340) ns of
              y : ys -> (y * f3 ys) `mod` 65563-- y * (y2 * (y3 * (y4 * (...))))
              [] -> 1
...
f4 [] = (0, [])
f4 (Just x:xs)
  | x == 60 = ((addRecurse (take 6 xs) (-1) `mod` 65563), (drop (min (terminateLength xs) 6) xs))
  | x == 32 = ((addRecurse (take 6 xs) (-2)) `mod` 65563, (drop 6 xs))
  | x == 41 = ((addRecurse (take 6 xs) 9) `mod` 65563, (drop 6 xs)) 
  | x == 71 = ((addRecurse (findStop xs 6 True) (-1)) `mod` 65563, (drop (length (findStop xs 6 True) + 1) xs))
  | x == 40 = ((addRecurse (findStop xs 3 False) (-2)) `mod` 65563, (drop (length (findStop xs 3 False) + 1) xs))
  | x == 68 = ((addRecurse (findStop xs 4 False) 6) `mod` 65563, (drop (length (findStop xs 4 False) + 1) xs))
  | x == 73 = ((mulRecurse (take 5 xs) (-1)) `mod` 65563, (drop (min (terminateLength xs) 5) xs))
  | x == 57 = ((mulRecurse (take 5 xs) (-2)) `mod` 65563, (drop 5 xs))
  | x == 52 = ((mulRecurse (take 6 xs) 7) `mod` 65563, (drop 6 xs))
  | x == 43 = ((mulRecurse (findStop xs 4 True) (-1)) `mod` 65563, (drop (length (findStop xs 4 True) + 1) xs))
  | x == 53 = ((mulRecurse (findStop xs 6 False) (-2)) `mod` 65563, (drop (length (findStop xs 6 False) + 1) xs))
  | x == 35 = ((mulRecurse (findStop xs 3 False) 1) `mod` 65563, (drop (length (findStop xs 3 False) + 1) xs))
  | otherwise = f4 xs
